...
//引用链接
//import {Test1ListRequest} from '@/sdk/api/test/test1/list'
/*
    ...
    let request = new Test1ListRequest();
    request.setParams(test1ListParams).api().then(res => {
        console.log("Test1ListRequest res:", res)
    })
