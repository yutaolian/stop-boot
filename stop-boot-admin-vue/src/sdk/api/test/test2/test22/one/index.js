...
export class Test22OneRequest {
    ...
    api() {
        const path = '/test/test2/test22/one'
...
//引用链接
//import {Test22OneRequest} from '@/sdk/api/test/test2/test22/one'
/*
    ...
    let request = new Test22OneRequest();
    request.setParams(test22OneParams).api().then(res => {
        console.log("Test22OneRequest res:", res)
    })
