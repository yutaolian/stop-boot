 ...
 * version: 1.0.1
    * desc: 详情
 */
export class Test22DeleteRequest {
    ...
    api() {
        const path = '/test/test2/test22/delete'
...
//引用链接
//import {Test22DeleteRequest} from '@/sdk/api/test/test2/test22/delete'
/*
    ...
    let request = new Test22DeleteRequest();
    request.setParams(test22DeleteParams).api().then(res => {
        console.log("Test22DeleteRequest res:", res)
    })
