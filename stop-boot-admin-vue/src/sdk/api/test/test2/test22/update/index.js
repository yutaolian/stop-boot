 ...
 * desc: 更新
 */
export class Test22UpdateRequest {
    ...
    api() {
        const path = '/test/test2/test22/update'
...
//引用链接
//import {Test22UpdateRequest} from '@/sdk/api/test/test2/test22/update'
/*
    ...
    let request = new Test22UpdateRequest();
    request.setParams(test22UpdateParams).api().then(res => {
        console.log("Test22UpdateRequest res:", res)
    })
