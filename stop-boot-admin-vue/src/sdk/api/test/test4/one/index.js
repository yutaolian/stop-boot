...
//引用链接
//import {Test4OneRequest} from '@/sdk/api/test/test4/one'
/*
    ...
    let request = new Test4OneRequest();
    request.setParams(test4OneParams).api().then(res => {
        console.log("Test4OneRequest res:", res)
    })
