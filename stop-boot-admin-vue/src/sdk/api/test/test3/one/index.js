...
//引用链接
//import {Test3OneRequest} from '@/sdk/api/test/test3/one'
/*
    ...
    let request = new Test3OneRequest();
    request.setParams(test3OneParams).api().then(res => {
        console.log("Test3OneRequest res:", res)
    })
