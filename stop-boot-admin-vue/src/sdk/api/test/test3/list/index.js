...
//引用链接
//import {Test3ListRequest} from '@/sdk/api/test/test3/list'
/*
    ...
    let request = new Test3ListRequest();
    request.setParams(test3ListParams).api().then(res => {
        console.log("Test3ListRequest res:", res)
    })
