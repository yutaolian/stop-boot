...
//引用链接
//import {MenuOneRequest} from '@/sdk/api/system/menu/one'
/*
    ...
    let request = new MenuOneRequest();
    request.setParams(menuOneParams).api().then(res => {
        console.log("MenuOneRequest res:", res)
    })
