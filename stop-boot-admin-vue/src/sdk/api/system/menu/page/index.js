...
//引用链接
//import {MenuPageRequest} from '@/sdk/api/system/menu/page'
/*
    ...
    let request = new MenuPageRequest();
    request.setParams(menuPageParams).api().then(res => {
        console.log("MenuPageRequest res:", res)
    })
