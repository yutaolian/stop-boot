 ...
 * desc: 详情
 */
export class DictionaryOneRequest {
    ...
    api() {
        const path = '/system/dictionary/one'
...
//引用链接
//import {DictionaryOneRequest} from '@/sdk/api/system/dictionary/one'
/*
    ...
    let request = new DictionaryOneRequest();
    request.setParams(dictionaryOneParams).api().then(res => {
        console.log("DictionaryOneRequest res:", res)
    })
