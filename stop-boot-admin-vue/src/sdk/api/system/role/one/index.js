...
//引用链接
//import {RoleOneRequest} from '@/sdk/api/system/role/one'
/*
    ...
    let request = new RoleOneRequest();
    request.setParams(roleOneParams).api().then(res => {
        console.log("RoleOneRequest res:", res)
    })
