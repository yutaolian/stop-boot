...
export class AdminUpdateRequest {
    ...
    api() {
        const path = '/system/admin/update'
...
//引用链接
//import {AdminUpdateRequest} from '@/sdk/api/system/admin/update'
/*
    ...
    request.setParams(adminUpdateParams).api().then(res => {
        console.log("AdminUpdateRequest res:", res)
    })
