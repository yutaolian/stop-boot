...
//引用链接
//import {AdminOneRequest} from '@/sdk/api/system/admin/one'
/*
    ...
    let request = new AdminOneRequest();
    request.setParams(adminOneParams).api().then(res => {
        console.log("AdminOneRequest res:", res)
    })
