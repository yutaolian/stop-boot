...
//引用链接
//import {AdminListRequest} from '@/sdk/api/system/admin/list'
/*
    ...
    let request = new AdminListRequest();
    request.setParams(adminListParams).api().then(res => {
        console.log("AdminListRequest res:", res)
    })
