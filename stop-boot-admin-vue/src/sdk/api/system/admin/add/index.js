...
//引用链接
//import {AdminAddRequest} from '@/sdk/api/system/admin/add'
/*
    ...
    request.setParams(adminAddParams).api().then(res => {
        console.log("AdminAddRequest res:", res)
    })
