 ...
 * version: 1.0.1
    * desc: 详情
 */
export class UserListDeleteRequest {
...
/*
    ...
    request.setParams(userListDeleteParams).api().then(res => {
        console.log("UserListDeleteRequest res:", res)
    })
