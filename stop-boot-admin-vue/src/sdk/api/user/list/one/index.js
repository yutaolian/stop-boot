 ...
 * desc: 详情
 */
export class UserListOneRequest {
...
//引用链接
//import {UserListOneRequest} from '@/sdk/api/user/list/one'
/*
    ...
    let request = new UserListOneRequest();
    request.setParams(userListOneParams).api().then(res => {
        console.log("UserListOneRequest res:", res)
    })
