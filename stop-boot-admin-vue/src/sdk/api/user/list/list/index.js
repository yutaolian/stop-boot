 ...
 * desc: 列表
 */
export class UserListListRequest {
...
//引用链接
//import {UserListListRequest} from '@/sdk/api/user/list/list'
/*
    ...
    let request = new UserListListRequest();
    request.setParams(userListListParams).api().then(res => {
        console.log("UserListListRequest res:", res)
    })
