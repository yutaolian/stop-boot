 ...
 * desc: 新增
 */
export class UserListAddRequest {
...
//引用链接
//import {UserListAddRequest} from '@/sdk/api/user/list/add'
/*
    ...
    let request = new UserListAddRequest();
    request.setParams(userListAddParams).api().then(res => {
        console.log("UserListAddRequest res:", res)
    })
