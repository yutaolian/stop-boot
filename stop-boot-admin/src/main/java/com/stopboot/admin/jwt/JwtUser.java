...
public class JwtUser implements UserDetails {
    ...
    public JwtUser(String id, String username, String password, List<String> authorities, boolean enabled) {
        this.id = id;
    ...
    public JwtUser(String id, String username, String password, String authoritie, boolean enabled) {
        this.id = id;
        this.username = username;
        this.password = password;
